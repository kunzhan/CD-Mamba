...
import math
import sys
sys.path.append('/home/ljs/rgbn/model')
...
class DA_Att_Bridge1(nn.Module):
    ...
    def forward(self, t1, t2, t3, t4, t5):
        ...
        # t1, t2, t3, t4, t5 = t1 + r1_, t2 + r2_, t3 + r3_, t4 + r4_, t5 + r5_ 
...
class UltraLight_VM_UNet(nn.Module):
    ...
    def __init__(self, num_classes=2, input_channels=4, c_list=[8,16,24,32,48,64],
        ...
        #     PVMLayer(input_channels, c_list[0]),
        # )
        self.encoder1 = nn.Sequential(
...
if __name__ == '__main__':
    model = UltraLight_VM_UNet(num_classes=2,input_channels=4).cuda()
